              ...
              {user ? (
                <div className="relative">
                  ...
                  >
                    ...
                    />
                    <span className="text-sm font-medium text-white">{user.user_metadata?.full_name || 'Kullanıcı'}</span>
                  ...
                  {userDropdownOpen && (
                    <div className="absolute right-0 top-full mt-2 w-56 bg-[#181920] border border-white/10 rounded-xl shadow-2xl py-2 animate-in fade-in zoom-in-95 duration-200">
                      <div className="px-4 py-3 border-b border-white/5 mb-2">
                        <p className="text-sm text-white font-medium">{user.user_metadata?.full_name}</p>
                        <p className="text-xs text-gray-400">@{user.user_metadata?.custom_claims?.discriminator || 'discord'}</p>
                      </div>
