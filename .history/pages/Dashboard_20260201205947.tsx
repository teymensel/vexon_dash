            ...
            >
                ...
                <div className="relative w-12 h-12 flex-shrink-0">
                  {server.icon ? (
                    <img 
                      ...
                      onError={(e) => {
                        (e.target as HTMLImageElement).src = `https://ui-avatars.com/api/?name=${encodeURIComponent(server.name)}&background=random`;
                      }}
                    />
                  ) : (
              ...
              <div>
                {server.hasBot ? (
                  ...
                  <button className="px-6 py-2 bg-white/5 hover:bg-white/10 text-white text-sm font-medium rounded-lg border border-white/10 transition-all hover:border-white/20 min-w-[100px]">
                    Davet et
                  </button>
                )}
              </div>
